    ...
    <div className="min-h-screen flex items-center justify-center bg-ink-950 px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-7 rounded-xl">
          <h2 className="text-lg font-display font-bold text-ink-950 mb-5">Create account</h2>
          ...
          <input
            ...
            className="w-full mb-2 px-3 py-2.5 border border-ink-800/15 rounded-lg text-sm focus:outline-none focus:border-accent-500"
          />
          <p className="text-xs text-ink-600 mb-6">First signup on the system becomes admin.</p>
          ...
          <p className="mt-5 text-sm text-ink-600 text-center">
            ...
            <Link to="/login" className="text-accent-600 font-medium">
              Log in
            </Link>
          </p>
        </form>
